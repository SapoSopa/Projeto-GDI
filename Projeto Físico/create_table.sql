...
CREATE TABLE Funcionario (
    ...
    CPF_chefe VARCHAR2(11) NOT NULL,
...
CREATE TABLE Avaliacao_Fisica (
    ...
    CONSTRAINT FK_CPF_FuncAF FOREIGN KEY (CPF_Func) REFERENCES Funcionario(CPF_func) ON DELETE CASCADE
);
...
CREATE TABLE Tem (
    ...
    CONSTRAINT PK_Tem PRIMARY KEY (CPF_Aluno, CPF_Func),
    CONSTRAINT FK_CPF_AlunoT FOREIGN KEY (CPF_Aluno) REFERENCES Aluno(CPF) ON DELETE CASCADE,
    CONSTRAINT FK_CPF_FuncionarioT FOREIGN KEY (CPF_Func) REFERENCES Instrutor(CPF) ON DELETE CASCADE
);
...
CREATE TABLE Ficha_de_treino (
    ...
    CPF_Aluno VARCHAR2(11) NOT NULL,
    CPF_Func VARCHAR2(11) NOT NULL,
    CONSTRAINT FK_CPF_Aluno_FuncFT FOREIGN KEY (CPF_Aluno, CPF_Func) REFERENCES Tem(CPF_Aluno, CPF_Func) ON DELETE CASCADE,
    CONSTRAINT FK_ID_ExercicioFT FOREIGN KEY (ID) REFERENCES Exercicio(ID) ON DELETE CASCADE
);
...
CREATE TABLE Realiza (
    ...
    ID NUMBER(10),
    Data DATE NOT NULL,
    CONSTRAINT PK_Realiza PRIMARY KEY (CPF_Aluno, COD_Equipamento, ID),
